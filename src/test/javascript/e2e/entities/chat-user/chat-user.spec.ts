...
describe('ChatUser e2e test', () => {
  ...
  it('should load ChatUsers', async () => {
    ...
    expect(await chatUserComponentsPage.getTitle()).to.eq('spingularchatsql5App.chatUser.home.title');
  });
  ...
  it('should load create ChatUser page', async () => {
    ...
    expect(await chatUserUpdatePage.getPageTitle()).to.eq('spingularchatsql5App.chatUser.home.createOrEditLabel');
  ...
  it('should delete last ChatUser', async () => {
    ...
    expect(await chatUserDeleteDialog.getDialogTitle()).to.eq('spingularchatsql5App.chatUser.delete.question');
