...
describe('OffensiveMessage e2e test', () => {
  ...
  it('should load OffensiveMessages', async () => {
    ...
    expect(await offensiveMessageComponentsPage.getTitle()).to.eq('spingularchatsql5App.offensiveMessage.home.title');
  });
  ...
  it('should load create OffensiveMessage page', async () => {
    ...
    expect(await offensiveMessageUpdatePage.getPageTitle()).to.eq('spingularchatsql5App.offensiveMessage.home.createOrEditLabel');
  ...
  it('should delete last OffensiveMessage', async () => {
    ...
    expect(await offensiveMessageDeleteDialog.getDialogTitle()).to.eq('spingularchatsql5App.offensiveMessage.delete.question');
