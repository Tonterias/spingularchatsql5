...
describe('ChatMessage e2e test', () => {
  ...
  it('should load ChatMessages', async () => {
    ...
    expect(await chatMessageComponentsPage.getTitle()).to.eq('spingularchatsql5App.chatMessage.home.title');
  });
  ...
  it('should load create ChatMessage page', async () => {
    ...
    expect(await chatMessageUpdatePage.getPageTitle()).to.eq('spingularchatsql5App.chatMessage.home.createOrEditLabel');
  ...
  it('should delete last ChatMessage', async () => {
    ...
    expect(await chatMessageDeleteDialog.getDialogTitle()).to.eq('spingularchatsql5App.chatMessage.delete.question');
