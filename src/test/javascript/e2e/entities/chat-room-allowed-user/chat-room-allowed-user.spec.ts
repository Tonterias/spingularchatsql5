...
describe('ChatRoomAllowedUser e2e test', () => {
  ...
  it('should load ChatRoomAllowedUsers', async () => {
    ...
    expect(await chatRoomAllowedUserComponentsPage.getTitle()).to.eq('spingularchatsql5App.chatRoomAllowedUser.home.title');
  });
  ...
  it('should load create ChatRoomAllowedUser page', async () => {
    ...
    expect(await chatRoomAllowedUserUpdatePage.getPageTitle()).to.eq('spingularchatsql5App.chatRoomAllowedUser.home.createOrEditLabel');
  ...
  it('should delete last ChatRoomAllowedUser', async () => {
    ...
    expect(await chatRoomAllowedUserDeleteDialog.getDialogTitle()).to.eq('spingularchatsql5App.chatRoomAllowedUser.delete.question');
