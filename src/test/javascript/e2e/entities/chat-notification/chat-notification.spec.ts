...
describe('ChatNotification e2e test', () => {
  ...
  it('should load ChatNotifications', async () => {
    ...
    expect(await chatNotificationComponentsPage.getTitle()).to.eq('spingularchatsql5App.chatNotification.home.title');
  });
  ...
  it('should load create ChatNotification page', async () => {
    ...
    expect(await chatNotificationUpdatePage.getPageTitle()).to.eq('spingularchatsql5App.chatNotification.home.createOrEditLabel');
  ...
  it('should delete last ChatNotification', async () => {
    ...
    expect(await chatNotificationDeleteDialog.getDialogTitle()).to.eq('spingularchatsql5App.chatNotification.delete.question');
