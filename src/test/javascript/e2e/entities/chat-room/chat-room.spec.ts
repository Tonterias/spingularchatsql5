...
describe('ChatRoom e2e test', () => {
  ...
  it('should load ChatRooms', async () => {
    ...
    expect(await chatRoomComponentsPage.getTitle()).to.eq('spingularchatsql5App.chatRoom.home.title');
  });
  ...
  it('should load create ChatRoom page', async () => {
    ...
    expect(await chatRoomUpdatePage.getPageTitle()).to.eq('spingularchatsql5App.chatRoom.home.createOrEditLabel');
  ...
  it('should delete last ChatRoom', async () => {
    ...
    expect(await chatRoomDeleteDialog.getDialogTitle()).to.eq('spingularchatsql5App.chatRoom.delete.question');
